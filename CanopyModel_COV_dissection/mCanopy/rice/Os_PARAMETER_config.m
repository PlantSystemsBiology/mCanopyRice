...
global TILLER_ANGLE;
DIRECTION_ORIENTATION = [pi/6, 7*pi/6, -pi/3, 2*pi/3, pi, 4*pi/3, pi/3, 0, -pi/6, pi/2, 5*pi/6, -pi/2, -5*pi/6, pi/6, -2*pi/3, pi/3, pi, 0, 2*pi/3, -pi/3, 2*pi/3, pi, 4*pi/3, pi/3, 0, -pi/6, pi/2, 5*pi/6, -pi/2, -5*pi/6, pi/6, -2*pi/3, pi/3, pi, 0, 2*pi/3, -pi/3];  % tiller angle and orientation angle, defined and used in Song et al, 2013
...
ROW_NUM = 4; % row number of canopy 
COL_NUM = 4; % col number 
