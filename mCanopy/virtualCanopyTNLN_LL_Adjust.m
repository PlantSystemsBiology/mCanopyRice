...
%% 同时改变LN和LL，交叉改变，直接改变TN 保持Leaf Area不变
function virtualCanopyTNLN_LL_Adjust(canopyModelParameter_file, TN_adjustValue, LN_adjustValue, outputCanopyModelParameter_file)
...
for plantId = 1:PN
    ...
    TN_B = TN_A + TN_adjustValue; % change tiller number
